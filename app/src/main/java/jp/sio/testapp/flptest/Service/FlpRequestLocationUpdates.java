...
public class FlpRequestLocationUpdates extends Service implements
    ...
    public class FlpRequestLocationUpdatesService_Binder extends Binder {
        public FlpRequestLocationUpdates getService() {
            return FlpRequestLocationUpdates.this;
        }
    }
    ...
    public void locationSuccess(final Location location) {
        ...
        if (runningCount == settingCount && settingCount != 0) {
            ...
            intervalTimerTask = new FlpRequestLocationUpdates.IntervalTimerTask();
    ...
    */
    ...
    public IBinder onBind(Intent intent) {
        return new FlpRequestLocationUpdatesService_Binder();
    }
