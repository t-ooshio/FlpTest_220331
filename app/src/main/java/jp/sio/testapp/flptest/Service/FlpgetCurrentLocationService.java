package jp.sio.testapp.flptest.Service;
...
public class FlpgetCurrentLocationService extends Service implements
    ...
    public class FlpGetCurrentLocationService_Binder extends Binder {
        public FlpgetCurrentLocationService getService() {
            return FlpgetCurrentLocationService.this;
        }
    }
    ...
    public void locationSuccess(final Location location) {
        ...
        if (runningCount == settingCount && settingCount != 0) {
            ...
            intervalTimerTask = new FlpgetCurrentLocationService.IntervalTimerTask();
    ...
    */
    ...
    public IBinder onBind(Intent intent) {
        return new FlpGetCurrentLocationService_Binder();
    }
